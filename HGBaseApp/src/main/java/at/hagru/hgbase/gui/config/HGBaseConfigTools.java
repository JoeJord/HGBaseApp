...
final public class HGBaseConfigTools {
	 ...
	 * @return the appropriate list preference
	 */
	public static ListPreference createListPreference(PreferenceActivity activity, String key, String[] values, Bitmap[] images, 
													  boolean showTextAndImage, String defaultValue) {
	 ...
	 */
	public static ListPreference createListPreference(PreferenceActivity activity, String key, String[] values, Bitmap[] images, 
													  boolean showTextAndImage, String defaultValue, boolean showSelectedValue) {
		...
		if (images == null || images.length == 0) {
			...
			for (int i = 0; i < images.length; i++) {
				if (images[i] != null) {
					valueImage[i] = HGBaseGuiTools.createStringForImage(activity.getApplicationContext(), images[i], 
																		HGBaseGuiTools.getButtonHeight(), 
																		HGBaseGuiTools.getScreenSize(activity).x / 2);
	 ...
	 */
	public static HGBaseSliderPreference createSliderPreference(PreferenceActivity activity, String key, int minValue, 
																int maxValue, int defaultValue, String unitText) {
	 ...
	 * @return the new created number preference
	 */
	public static HGBaseNumberPickerPreference createNumberPickerPreference(PreferenceActivity activity, String key, 
																			int minValue, int maxValue, int diff, 
																			int defaultValue) {
	...
	public static HGBaseNumberPickerPreference createNumberPickerPreference(PreferenceActivity activity, String key, 
																			int minValue, int maxValue, int diff, 
																			int defaultValue, boolean showPickedValue) {
